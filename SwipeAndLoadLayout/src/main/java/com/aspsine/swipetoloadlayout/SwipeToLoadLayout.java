...
public class SwipeToLoadLayout extends ViewGroup {
    ...
    private OnPrepareAndResetListener mPrepareAndResetListener;
...
//            mFooterView = findViewById(R.id.swipe_load_more_footer);
            ...
            throw new IllegalStateException("子控件数量少于3，是不是没添加header和footer?");
        }
        if (mTargetView == null) {
            return;
        }
    ...
    public void setOnPrepareAndReseListener(OnPrepareAndResetListener listener) {
        this.mPrepareAndResetListener = listener;
    }
    /**
    ...
    LoadMoreCallback mLoadMoreCallback = new LoadMoreCallback() {
        ...
        public void onPrepare() {
            if (mFooterView != null && mFooterView instanceof SwipeTrigger && STATUS.isStatusDefault(mStatus)) {
                ...
                if (mPrepareAndResetListener!=null){
                    mPrepareAndResetListener.onPrepare();
                }
            }
        }
        ...
        public void onReset() {
            if (mFooterView != null && mFooterView instanceof SwipeTrigger && STATUS.isStatusDefault(mStatus)) {
                ...
                mFooterView.setVisibility(GONE);
                if (mPrepareAndResetListener!=null){
                    mPrepareAndResetListener.onReset();
                }
            }
        }
    };

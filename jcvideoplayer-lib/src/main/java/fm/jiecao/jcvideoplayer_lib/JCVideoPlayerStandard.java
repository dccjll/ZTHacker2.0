...
public class JCVideoPlayerStandard extends JCVideoPlayer {
    ...
    public void init(Context context) {
        ...
        /*---------------我是华丽丽的分割线------------------*/
        rl_no_wifi = (RelativeLayout) findViewById(R.id.rl_no_wifi);
    ...
    public void setUp(LinkedHashMap urlMap, int defaultUrlMapIndex, int screen, Object... objects) {
        ...
        if (currentScreen == SCREEN_WINDOW_FULLSCREEN) {
            ...
            //thumbImageView.setImageBitmap(mmr.getFrameAtTime(0,MediaMetadataRetriever.OPTION_NEXT_SYNC));
    ...
    public void showWifiDialog(int action) {
        ...
        rl_no_wifi.setVisibility(VISIBLE);
        tv_continue.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                rl_no_wifi.setVisibility(GONE);
                onEvent(JCUserActionStandard.ON_CLICK_START_THUMB);
                startVideo();

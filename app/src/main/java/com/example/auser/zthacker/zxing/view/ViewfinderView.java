...
package com.example.auser.zthacker.zxing.view;
...
public final class ViewfinderView extends View
{
  ...
  public ViewfinderView(Context context, AttributeSet attrs) {
    ...
    maskColor = resources.getColor(R.color.tab_bg_fa);
    resultColor = resources.getColor(R.color.send_captcha_bg);
    frameColor = resources.getColor(R.color.send_captcha_bg);
    laserColor = resources.getColor(R.color.send_captcha_bg);
  ...
  public void onDraw(Canvas canvas) {
   ...
   paint.setColor(resultBitmap != null ? resultColor : maskColor);
    ...
    if (resultBitmap != null) {
      ...
      //直接用图片
           /* Rect bigRect = new Rect();
            bigRect.left = frame.left;
      		...
      		Drawable drawable =  getResources().getDrawable(R.mipmap.scan_background);
      ...
      //自己画
      paint.setColor(getResources().getColor(R.color.send_captcha_bg));
      ...
      //用图片
           /* Rect lineRect = new Rect();
      		...
      		canvas.drawBitmap(((BitmapDrawable)(getResources().getDrawable(R.mipmap.scan_light))).getBitmap(), null, lineRect, paint);*/
      //画扫描框下面的字
      /*paint.setColor(getResources().getColor(R.color.text_90));
      paint.setTextSize(TEXT_SIZE * density);
      paint.setAlpha(0x40);
      paint.setTypeface(Typeface.create("System", Typeface.NORMAL));
      canvas.drawText(
              "扫描完成后，课程二维码将与您的账号绑定，同时您也可以观看课程的完整视频",
              0,
              34,
              frame.left,
              frame.bottom + TEXT_PADDING_TOP * density*2,
              paint);*/
    /*  paint.setColor(getResources().getColor(R.color.text_90));
      paint.setTextSize(TEXT_SIZE * density);
      paint.setAlpha(0x40);
      paint.setTypeface(Typeface.create("System", Typeface.NORMAL));*/
   /* String topText =  "将课程二维码放入框内，即可自动扫描";
      canvas.drawText(
              topText,
              frame.left,
              frame.top - TEXT_PADDING_TOP * density,
              paint);*/
      /*Bitmap bitmap = ((BitmapDrawable) (getResources().getDrawable(R.mipmap.zxing_bottom))).getBitmap();
      bitmap.setWidth(450);
      bitmap.setHeight(40);
      canvas.drawBitmap(bitmap,
              frame.left, frame.bottom + TEXT_PADDING_TOP * density, paint);*/
      /*canvas.drawBitmap(((BitmapDrawable)(getResources().getDrawable(R.mipmap.erweima))).getBitmap(),
              frame.right-((BitmapDrawable)(getResources().getDrawable(R.mipmap.erweima))).getBitmap().getWidth(),
